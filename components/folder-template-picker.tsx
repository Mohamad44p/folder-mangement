        ...
        >
          ...
          >
            <div className="px-5 py-4 border-b border-white/[0.06] flex items-center">
              <div>
                <h3 className="text-[15px] font-semibold text-white">New folder from template</h3>
                <p className="text-[12px] text-white/40">Pick a template to scaffold subfolders.</p>
              </div>
              <button
                onClick={() => setTemplatePickerOpen(false)}
                ...
                <button
                  ...
                  onClick={() => {
                    const id = createFromTemplate(
                      null,
                      {
                        title: tpl.name === "Blank" ? "New Folder" : tpl.name,
                        icon: tpl.rootIcon,
                        color: tpl.rootColor,
                      },
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-[13px] font-medium text-white">{tpl.name}</div>
                      <div className="text-[11px] text-white/40 truncate">{tpl.description}</div>
                    </div>
                  </div>
