      ...
      >
        <div className="relative w-[288px] h-fit mb-4">
          <div
            ...
            style={{ background: "linear-gradient(180deg, var(--failed-bg-from) 0%, var(--failed-bg-to) 100%)" }}
          >
            <div
              className="absolute inset-0 rounded-2xl"
              style={{ background: "radial-gradient(circle at 50% 60%, var(--failed-glow), transparent 70%)" }}
            />
                ...
                return (
                  ...
                  >
                    <svg width={size} height={size} viewBox="0 0 16 16" fill="none">
                      <rect x="2" y="1" width="12" height="1" fill="var(--failed-icon-light)" />
                      <rect x="1" y="2" width="1" height="12" fill="var(--failed-icon-light)" />
                      <rect x="14" y="2" width="1" height="12" fill="var(--failed-icon-light)" />
                      <rect x="2" y="14" width="12" height="1" fill="var(--failed-icon-light)" />
                      <rect x="2" y="2" width="1" height="1" fill="var(--failed-icon-light)" />
                      <rect x="13" y="2" width="1" height="1" fill="var(--failed-icon-light)" />
                      <rect x="2" y="13" width="1" height="1" fill="var(--failed-icon-light)" />
                      <rect x="13" y="13" width="1" height="1" fill="var(--failed-icon-light)" />
                      <rect x="4" y="5" width="2" height="3" fill="var(--failed-icon-dark)" />
                      <rect x="10" y="5" width="2" height="3" fill="var(--failed-icon-dark)" />
                      <rect x="5" y="11" width="1" height="1" fill="var(--failed-icon-dark)" />
                      <rect x="6" y="10" width="4" height="1" fill="var(--failed-icon-dark)" />
                      <rect x="10" y="11" width="1" height="1" fill="var(--failed-icon-dark)" />
                    </svg>
                  </div>
                )
              })}
          ...
          <div
            ...
            style={{
              background: "linear-gradient(180deg, var(--failed-card-from) 0%, var(--failed-card-to) 100%)",
            }}
          >
            ...
            <div className="relative h-[48px]">
              ...
              <div className="absolute inset-0 flex items-center justify-between px-4 pr-2">
                <span className="text-[13px] text-red-400/60">{t("card.processingFailed")}</span>
